...
var CsuActivitiesReport = function CsuActivitiesReport(props) {
  ...
  var userHealthFacility = useSelector(function (state) {
    return state.core.user.claim_admin.healthFacility;
  });
...
var CsuActivitiesReport$1 = injectIntl(CsuActivitiesReport);
...
var CsuBirthPaymentStatusReport$1 = injectIntl(CsuBirthPaymentStatusReport);
...
var CsuStateDiscritPaymentReport$1 = injectIntl(CsuStateDiscritPaymentReport);
...
var CsuFagepReport$1 = injectIntl(CsuFagepReport);
